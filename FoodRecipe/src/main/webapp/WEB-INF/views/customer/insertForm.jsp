...
<form class="form" onsubmit="return false" autocomplete="off">
		<div class="form-inner">
			...
			<div class="input-wrapper">
				<label for="login-username">User I D</label>
...
<!-- 	이미지 -->
					...
					</span> <input type="text" id="login-username" data-lpignore="true">
				</div>
			</div>
			...
			<div class="input-wrapper">
				...
				<div class="input-group">
					...
					</span> <input type="password" id="login-password" data-lpignore="true">
				</div>
			</div>
			<div class="btn-group">
				<a class="btn btn--text" href="#0">아이디 찾기</a> <a
					class="btn btn--text" href="#0">비밀번호 찾기</a>
			</div>
	...
	<form action="./insert.do" method="post" enctype="multipart/form-data">
		<table>
			...
			<tr>
				<td>첨부파일</td>
				<td><input type="file" name="cusImg"></td>
			</tr>
		</table>
